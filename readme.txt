...
Real3D Flipbook Lite is PDF viewer / PDF embedder plugin that displays your PDF-s inside your website. Real3D Flipbook uses only javascript, no iframes or third party services are used. 
...
This is lite version of [Real3D Flipbook](https://codecanyon.net/item/real3d-flipbook-wordpress-plugin/6942587) which is popular premium plugin and offers extra features such as PDF hyperlinks, PDF search, Lightbox (popup) mode and Fullscreen
